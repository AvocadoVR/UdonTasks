...
| Continue() | Conditional: If your task is marked as Manual Confirmation. You will need to use this after your logic in your callback. | If you want something to execute and make sure the data has time to update. This would be useful for you. |
| SetCondition(bool Condition) | Conditional: Whether you mark it as Repeat til Fulfillment. This will be needed to tell the Task how to proceed.<br><br>True: It met the condition.<br><br>False: It didn't meet the condition. | If you have something that shouldn't execute unless these conditions are met. |
